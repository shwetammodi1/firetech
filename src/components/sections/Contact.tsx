...
export default function Contact() {
  ...
  const inputClass = [
    'w-full bg-dark-700/60 border border-neutral-900/8 rounded-xl px-4 py-3 text-sm text-smoke-200',
  ...
  return (
    <section id="contact" className="relative section-padding bg-dark-800 overflow-hidden">
      ...
      <div
        ...
        style={{ background: 'radial-gradient(circle, rgba(230, 47, 16,0.09) 0%, transparent 65%)' }}
      />
      ...
      <Container>
        ...
        <div className="grid md:grid-cols-2 gap-10 items-start">
          ...
          >
            ...
            {INFO_ITEMS.map(({ icon: Icon, label, value, href }) => (
              <motion.a
                ...
                variants={fadeUp}
                href={href}
                className="flex items-center gap-4 glass rounded-2xl border border-neutral-900/5 p-5 hover:border-fire-500/20 hover:bg-fire-500/[0.03] transition-all duration-300 group"
              >
          ...
          >
            <div className="glass rounded-3xl border border-neutral-900/6 p-5 sm:p-8">
              {formState === 'success' ? (
