...
const WHATSAPP_URL =
  'https://wa.me/917000000000?text=Hello%20Firetech%20Enterprises%2C%20I%20need%20a%20fire%20safety%20quote.'
            ...
            {tooltip && !dismissed && (
              ...
              >
                <button
                  ...
                  aria-label="Dismiss"
                  className="absolute -top-2 -right-2 w-5 h-5 rounded-full bg-dark-700 border border-white/10 flex items-center justify-center text-smoke-500 hover:text-smoke-300 transition-colors"
                >
                  <X className="w-3 h-3" />
                </button>
